...
Module
{
  ...
  // Expose shift state to screen for mixer mode display
  MappingPropertyDescriptor { id: mixerShiftActiveProp; path: module.propertiesPath + ".mixer_shift_active"; type: MappingPropertyDescriptor.Boolean; value: module.shift }

  // Key adjust: intermediate property to scale knob 0-1 range to key.adjust -1 to +1 range
  AppProperty { id: keyAdjustAppProp; path: "app.traktor.decks." + module.deckIdx + ".track.key.adjust" }
  MappingPropertyDescriptor {
    id: keyKnobValueProp
    path: module.propertiesPath + ".key_knob_value"
    type: MappingPropertyDescriptor.Float
    value: 0.5
    onValueChanged: {
      keyAdjustAppProp.value = (value * 2.0) - 1.0
    }
  }

  // --- Mixer Mode: Stem Volume (default) ---
  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer) && !module.shift

    Wire { from: "softtakeover1.output"; to: ValuePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.1.volume"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.2.volume"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover3.output"; to: ValuePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.3.volume"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.4.volume"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }

    Wire { from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.1.muted"; color: stemColorId_1.value; invertBrightness: true } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.2.muted"; color: stemColorId_2.value; invertBrightness: true } }
    Wire { from: "%surface%.buttons.3"; to: TogglePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.3.muted"; color: stemColorId_3.value; invertBrightness: true } }
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.decks." + module.deckIdx + ".stems.4.muted"; color: stemColorId_4.value; invertBrightness: true } }
  }

  // --- Mixer Mode: EQ + Volume (shift held) ---
  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer) && module.shift && (module.deckIdx == 1)
    ...
    Wire { from: "softtakeover4.output"; to: ValuePropertyAdapter { path: module.propertiesPath + ".key_knob_value"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.decks.1.track.key.lock_enabled"; color: Color.Blue } }
  }

  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer) && module.shift && (module.deckIdx == 2)
    ...
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.decks.2.track.key.lock_enabled"; color: Color.Blue } }
  }

  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer) && module.shift && (module.deckIdx == 3)
    ...
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.decks.3.track.key.lock_enabled"; color: Color.Blue } }
  }

  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer) && module.shift && (module.deckIdx == 4)
    ...
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.decks.4.track.key.lock_enabled"; color: Color.Blue } }
  }
}
